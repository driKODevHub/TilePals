...
Shader "Toony Colors Pro 2/User/MainMaterial_InsideStencil_Eyes"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
	...
	SubShader
	{
		...
		Pass
		{
			...
			) : SV_Target
			{
				...
				float3 __diffuseTintMask = ( TCP2_TEX2D_SAMPLE(_DiffuseTintMask, _DiffuseTintMask, input.pack0.xy).rgb );
...
/* TCP_DATA u config(ver:"2.9.20";unity:"6000.3.0f1";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","UNITY_6000_2","UNITY_6000_1","UNITY_6000_0","ENABLE_DEPTH_NORMALS_PASS","ENABLE_FORWARD_PLUS","TEXBLEND_NORMALIZE","SHADOW_LINE","SHADOW_LINE_CRISP_AA","ALBEDO_HSV_SATURATION","TEXTURED_THRESHOLD","TT_SHADER_FEATURE","DIFFUSE_TINT","DIFFUSE_TINT_MASK","OUTLINE_URP_FEATURE","OUTLINE_CONSTANT_SIZE","WRAPPED_LIGHTING_HALF","RIM","SPECULAR_NO_ATTEN","SPECULAR_SHADER_FEATURE","SPECULAR","SPEC_LEGACY","SPECULAR_TOON_BAND","STENCIL","ENABLE_COOKIES","TEMPLATE_LWRP"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0",RIM_LABEL="Rim Lighting"];shaderProperties:list[,,,,,,,,,,,,,,,,,,,,,,,,,,sp(name:"Stencil Reference";imps:list[imp_constant(type:fixed_function_float;fprc:float;fv:2;f2v:(1, 1);f3v:(1, 1, 1);f4v:(1, 1, 1, 1);cv:RGBA(1, 1, 1, 1);guid:"7ecf2811-541c-4cf2-9dda-0cfd06096b29";op:Multiply;lbl:"Reference";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False),,,sp(name:"Stencil Comparison";imps:list[imp_enum(value_type:0;value:3;enum_type:"ToonyColorsPro.ShaderGenerator.CompareFunction";guid:"2387e239-2b1a-4418-b643-a36a7f571c75";op:Multiply;lbl:"Stencil Comparison";gpu_inst:False;dots_inst:False;locked:False;impl_index:0)];layers:list[];unlocked:list[];layer_blend:dict[];custom_blend:dict[];clones:dict[];isClone:False)];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 58ace262c44e03ae0c82baadd4c95f2d */
